// 18+ Hotel Finder page moved to /hotel-finder
'use client';
...
export default function Page() {
  ...
  // Show unknown-policy hotels by default so that users can see all results unless they choose otherwise.
  ...
  React.useEffect(() => {
    // initial demo search around Sacramento
